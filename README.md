...
Этот репозиторий содержит собственные реализации основных алгоритмов машинного обучения "с нуля" с использованием только NumPy, а также подробные сравнения с оригинальными реализациями из scikit-learn в мини-исследованиях в Jupyter Notebboks.
